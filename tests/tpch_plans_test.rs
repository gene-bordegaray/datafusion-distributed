...
mod tests {
    ...
    async fn test_tpch_1() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 2] => NetworkCoalesceExec: output_partitions=24, input_tasks=2
        └──────────────────────────────────────────────────
          ...
          │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[l_returnflag@0, l_linestatus@1]
          │         [Stage 1] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
            │ RepartitionExec: partitioning=Hash([l_returnflag@0, l_linestatus@1], 6), input_partitions=4
            ...
            │         PartitionIsolatorExec: tasks=4 partitions=16
    ...
    async fn test_tpch_2() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 11] => NetworkCoalesceExec: output_partitions=48, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 11 ── Tasks: t0:[p0..p11] t1:[p0..p11] t2:[p0..p11] t3:[p0..p11]
          ...
          │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[p_partkey@0, ps_supplycost@7]
          │         [Stage 5] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[ps_partkey@1, min(partsupp.ps_supplycost)@0]
          │         [Stage 10] => NetworkShuffleExec: output_partitions=6, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 5 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
            │ RepartitionExec: partitioning=Hash([p_partkey@0, ps_supplycost@7], 6), input_partitions=4
            ...
            │ RepartitionExec: partitioning=Hash([ps_partkey@1, min(partsupp.ps_supplycost)@0], 6), input_partitions=12
            ...
            │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[ps_partkey@0]
            │         [Stage 9] => NetworkShuffleExec: output_partitions=6, input_tasks=4
            └──────────────────────────────────────────────────
              ┌───── Stage 9 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
              │ RepartitionExec: partitioning=Hash([ps_partkey@0], 6), input_partitions=4
    ...
    async fn test_tpch_3() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 4] => NetworkCoalesceExec: output_partitions=36, input_tasks=3
        └──────────────────────────────────────────────────
          ...
          │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[l_orderkey@0, o_orderdate@1, o_shippriority@2]
          │         [Stage 3] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 3 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
            │ RepartitionExec: partitioning=Hash([l_orderkey@0, o_orderdate@1, o_shippriority@2], 6), input_partitions=4
    ...
    async fn test_tpch_5() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 7] => NetworkCoalesceExec: output_partitions=36, input_tasks=3
        └──────────────────────────────────────────────────
          ┌───── Stage 7 ── Tasks: t0:[p0..p11] t1:[p0..p11] t2:[p0..p11]
          ...
          │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[n_name@0]
          │         [Stage 6] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 6 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
            │ RepartitionExec: partitioning=Hash([n_name@0], 6), input_partitions=4
            ...
            │                 CoalescePartitionsExec
            │                   [Stage 5] => NetworkBroadcastExec: partitions_per_consumer=4, stage_partitions=16, input_tasks=4
            │                 PartitionIsolatorExec: tasks=4 partitions=16
            │                   DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/lineitem/1.parquet], [/testdata/tpch/plan_sf0.02/lineitem/10.parquet], [/testdata/tpch/plan_sf0.02/lineitem/11.parquet], [/testdata/tpch/plan_sf0.02/lineitem/12.parquet], [/testdata/tpch/plan_sf0.02/lineitem/13.parquet], ...]}, projection=[l_orderkey, l_suppkey, l_extendedprice, l_discount], file_type=parquet, predicate=DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
              ┌───── Stage 1 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
              │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
              ...
              │     DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/supplier/1.parquet], [/testdata/tpch/plan_sf0.02/supplier/10.parquet], [/testdata/tpch/plan_sf0.02/supplier/11.parquet], [/testdata/tpch/plan_sf0.02/supplier/12.parquet], [/testdata/tpch/plan_sf0.02/supplier/13.parquet], ...]}, projection=[s_suppkey, s_nationkey], file_type=parquet, predicate=DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
              ┌───── Stage 5 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
              │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
              ...
              └──────────────────────────────────────────────────
                ...
                │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
                │   PartitionIsolatorExec: tasks=4 partitions=16
                │     DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/customer/1.parquet], [/testdata/tpch/plan_sf0.02/customer/10.parquet], [/testdata/tpch/plan_sf0.02/customer/11.parquet], [/testdata/tpch/plan_sf0.02/customer/12.parquet], [/testdata/tpch/plan_sf0.02/customer/13.parquet], ...]}, projection=[c_custkey, c_nationkey], file_type=parquet
                └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_7() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[supp_nation@0, cust_nation@1, l_year@2]
          │         [Stage 6] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 6 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
            │ RepartitionExec: partitioning=Hash([supp_nation@0, cust_nation@1, l_year@2], 6), input_partitions=4
            ...
            └──────────────────────────────────────────────────
              ...
              │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
              │   PartitionIsolatorExec: tasks=4 partitions=16
              │     DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/customer/1.parquet], [/testdata/tpch/plan_sf0.02/customer/10.parquet], [/testdata/tpch/plan_sf0.02/customer/11.parquet], [/testdata/tpch/plan_sf0.02/customer/12.parquet], [/testdata/tpch/plan_sf0.02/customer/13.parquet], ...]}, projection=[c_custkey, c_nationkey], file_type=parquet, predicate=DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
              ┌───── Stage 4 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
              │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
              │   PartitionIsolatorExec: tasks=4 partitions=16
              │     DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/orders/1.parquet], [/testdata/tpch/plan_sf0.02/orders/10.parquet], [/testdata/tpch/plan_sf0.02/orders/11.parquet], [/testdata/tpch/plan_sf0.02/orders/12.parquet], [/testdata/tpch/plan_sf0.02/orders/13.parquet], ...]}, projection=[o_orderkey, o_custkey], file_type=parquet, predicate=DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
              ┌───── Stage 5 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
              │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
              │   PartitionIsolatorExec: tasks=4 partitions=16
    ...
    async fn test_tpch_8() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 9] => NetworkCoalesceExec: output_partitions=36, input_tasks=3
        └──────────────────────────────────────────────────
          ┌───── Stage 9 ── Tasks: t0:[p0..p11] t1:[p0..p11] t2:[p0..p11]
          ...
          │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[o_year@0]
          │         [Stage 8] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 8 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
            │ RepartitionExec: partitioning=Hash([o_year@0], 6), input_partitions=4
            ...
            │                                 [Stage 7] => NetworkBroadcastExec: partitions_per_consumer=4, stage_partitions=16, input_tasks=4
            │                               PartitionIsolatorExec: tasks=4 partitions=16
            │                                 DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/lineitem/1.parquet], [/testdata/tpch/plan_sf0.02/lineitem/10.parquet], [/testdata/tpch/plan_sf0.02/lineitem/11.parquet], [/testdata/tpch/plan_sf0.02/lineitem/12.parquet], [/testdata/tpch/plan_sf0.02/lineitem/13.parquet], ...]}, projection=[l_orderkey, l_partkey, l_suppkey, l_extendedprice, l_discount], file_type=parquet, predicate=DynamicFilter [ empty ] AND DynamicFilter [ empty ] AND DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
              ┌───── Stage 1 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
              │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
              ...
              │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
              │   PartitionIsolatorExec: tasks=4 partitions=16
              │     DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/nation/1.parquet], [/testdata/tpch/plan_sf0.02/nation/10.parquet], [/testdata/tpch/plan_sf0.02/nation/11.parquet], [/testdata/tpch/plan_sf0.02/nation/12.parquet], [/testdata/tpch/plan_sf0.02/nation/13.parquet], ...]}, projection=[n_nationkey, n_name], file_type=parquet
              └──────────────────────────────────────────────────
              ┌───── Stage 3 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
              │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
              │   PartitionIsolatorExec: tasks=4 partitions=16
    ...
    async fn test_tpch_9() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[nation@0, o_year@1]
          │         [Stage 6] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 6 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
            │ RepartitionExec: partitioning=Hash([nation@0, o_year@1], 6), input_partitions=4
            ...
            │                         [Stage 5] => NetworkBroadcastExec: partitions_per_consumer=4, stage_partitions=16, input_tasks=4
            │                       PartitionIsolatorExec: tasks=4 partitions=16
            │                         DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/lineitem/1.parquet], [/testdata/tpch/plan_sf0.02/lineitem/10.parquet], [/testdata/tpch/plan_sf0.02/lineitem/11.parquet], [/testdata/tpch/plan_sf0.02/lineitem/12.parquet], [/testdata/tpch/plan_sf0.02/lineitem/13.parquet], ...]}, projection=[l_orderkey, l_partkey, l_suppkey, l_quantity, l_extendedprice, l_discount], file_type=parquet, predicate=DynamicFilter [ empty ] AND DynamicFilter [ empty ] AND DynamicFilter [ empty ] AND DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
              ┌───── Stage 1 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
              │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
              │   PartitionIsolatorExec: tasks=4 partitions=16
    ...
    async fn test_tpch_10() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 5] => NetworkCoalesceExec: output_partitions=36, input_tasks=3
        └──────────────────────────────────────────────────
          ┌───── Stage 5 ── Tasks: t0:[p0..p11] t1:[p0..p11] t2:[p0..p11]
          ...
          │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[c_custkey@0, c_name@1, c_acctbal@2, c_phone@3, n_name@4, c_address@5, c_comment@6]
          │         [Stage 4] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 4 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
            │ RepartitionExec: partitioning=Hash([c_custkey@0, c_name@1, c_acctbal@2, c_phone@3, n_name@4, c_address@5, c_comment@6], 6), input_partitions=4
    ...
    async fn test_tpch_11() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │           [Stage 2] => NetworkBroadcastExec: partitions_per_consumer=4, stage_partitions=16, input_tasks=4
          │         PartitionIsolatorExec: tasks=4 partitions=16
          │           DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/partsupp/1.parquet], [/testdata/tpch/plan_sf0.02/partsupp/10.parquet], [/testdata/tpch/plan_sf0.02/partsupp/11.parquet], [/testdata/tpch/plan_sf0.02/partsupp/12.parquet], [/testdata/tpch/plan_sf0.02/partsupp/13.parquet], ...]}, projection=[ps_suppkey, ps_availqty, ps_supplycost], file_type=parquet, predicate=DynamicFilter [ empty ]
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
            │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
          ...
          │             [Stage 5] => NetworkBroadcastExec: partitions_per_consumer=4, stage_partitions=16, input_tasks=4
          │           PartitionIsolatorExec: tasks=4 partitions=16
          │             DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/partsupp/1.parquet], [/testdata/tpch/plan_sf0.02/partsupp/10.parquet], [/testdata/tpch/plan_sf0.02/partsupp/11.parquet], [/testdata/tpch/plan_sf0.02/partsupp/12.parquet], [/testdata/tpch/plan_sf0.02/partsupp/13.parquet], ...]}, projection=[ps_partkey, ps_suppkey, ps_availqty, ps_supplycost], file_type=parquet, predicate=DynamicFilter [ empty ]
          └──────────────────────────────────────────────────
            ┌───── Stage 4 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
            │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
            │   FilterExec: n_name@1 = GERMANY, projection=[n_nationkey@0]
    ...
    async fn test_tpch_12() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 3] => NetworkCoalesceExec: output_partitions=36, input_tasks=3
        └──────────────────────────────────────────────────
          ...
          │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[l_shipmode@0]
          │         [Stage 2] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 2 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
            │ RepartitionExec: partitioning=Hash([l_shipmode@0], 6), input_partitions=4
    ...
    async fn test_tpch_13() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 3] => NetworkCoalesceExec: output_partitions=24, input_tasks=2
        └──────────────────────────────────────────────────
          ┌───── Stage 3 ── Tasks: t0:[p0..p11] t1:[p0..p11]
          ...
          │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[c_count@0]
          │         [Stage 2] => NetworkShuffleExec: output_partitions=6, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 2 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5]
            │ RepartitionExec: partitioning=Hash([c_count@0], 6), input_partitions=12
            ...
            │         LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[c_custkey@0]
            │           [Stage 1] => NetworkShuffleExec: output_partitions=6, input_tasks=4
            └──────────────────────────────────────────────────
              ┌───── Stage 1 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
              │ RepartitionExec: partitioning=Hash([c_custkey@0], 6), input_partitions=4
              ...
              │       CoalescePartitionsExec
              │         PartitionIsolatorExec: tasks=4 partitions=16
              │           DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/customer/1.parquet], [/testdata/tpch/plan_sf0.02/customer/10.parquet], [/testdata/tpch/plan_sf0.02/customer/11.parquet], [/testdata/tpch/plan_sf0.02/customer/12.parquet], [/testdata/tpch/plan_sf0.02/customer/13.parquet], ...]}, projection=[c_custkey], file_type=parquet
    ...
    async fn test_tpch_14() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
            │   PartitionIsolatorExec: tasks=4 partitions=16
            │     DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/part/1.parquet], [/testdata/tpch/plan_sf0.02/part/10.parquet], [/testdata/tpch/plan_sf0.02/part/11.parquet], [/testdata/tpch/plan_sf0.02/part/12.parquet], [/testdata/tpch/plan_sf0.02/part/13.parquet], ...]}, projection=[p_partkey, p_type], file_type=parquet
            └──────────────────────────────────────────────────
        "#);
        Ok(())
    }
    ...
    async fn test_tpch_15() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 6] => NetworkCoalesceExec: output_partitions=48, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 6 ── Tasks: t0:[p0..p11] t1:[p0..p11] t2:[p0..p11] t3:[p0..p11]
          ...
          │           LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[l_suppkey@0]
          │             [Stage 5] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          └──────────────────────────────────────────────────
            ...
            │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
            │   PartitionIsolatorExec: tasks=4 partitions=16
            │     DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/supplier/1.parquet], [/testdata/tpch/plan_sf0.02/supplier/10.parquet], [/testdata/tpch/plan_sf0.02/supplier/11.parquet], [/testdata/tpch/plan_sf0.02/supplier/12.parquet], [/testdata/tpch/plan_sf0.02/supplier/13.parquet], ...]}, projection=[s_suppkey, s_name, s_address, s_phone], file_type=parquet
            └──────────────────────────────────────────────────
            ┌───── Stage 5 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
            │ RepartitionExec: partitioning=Hash([l_suppkey@0], 6), input_partitions=4
            │   AggregateExec: mode=Partial, gby=[l_suppkey@0 as l_suppkey], aggr=[sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)]
            │     FilterExec: l_shipdate@3 >= 1996-01-01 AND l_shipdate@3 < 1996-04-01, projection=[l_suppkey@0, l_extendedprice@1, l_discount@2]
            │       PartitionIsolatorExec: tasks=4 partitions=16
            │         DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/lineitem/1.parquet], [/testdata/tpch/plan_sf0.02/lineitem/10.parquet], [/testdata/tpch/plan_sf0.02/lineitem/11.parquet], [/testdata/tpch/plan_sf0.02/lineitem/12.parquet], [/testdata/tpch/plan_sf0.02/lineitem/13.parquet], ...]}, projection=[l_suppkey, l_extendedprice, l_discount, l_shipdate], file_type=parquet, predicate=l_shipdate@10 >= 1996-01-01 AND l_shipdate@10 < 1996-04-01 AND DynamicFilter [ empty ], pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1996-01-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 < 1996-04-01, required_guarantees=[]
            └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_16() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 5] => NetworkCoalesceExec: output_partitions=24, input_tasks=2
        └──────────────────────────────────────────────────
          ┌───── Stage 5 ── Tasks: t0:[p0..p11] t1:[p0..p11]
          ...
          │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[p_brand@0, p_type@1, p_size@2]
          │         [Stage 4] => NetworkShuffleExec: output_partitions=6, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 4 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5]
            │ RepartitionExec: partitioning=Hash([p_brand@0, p_type@1, p_size@2], 6), input_partitions=12
            ...
            │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[p_brand@0, p_type@1, p_size@2, alias1@3]
            │         [Stage 3] => NetworkShuffleExec: output_partitions=6, input_tasks=4
            └──────────────────────────────────────────────────
              ┌───── Stage 3 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
              │ RepartitionExec: partitioning=Hash([p_brand@0, p_type@1, p_size@2, alias1@3], 6), input_partitions=4
              ...
              │             [Stage 2] => NetworkBroadcastExec: partitions_per_consumer=4, stage_partitions=16, input_tasks=4
              │           PartitionIsolatorExec: tasks=4 partitions=16
              │             DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/partsupp/1.parquet], [/testdata/tpch/plan_sf0.02/partsupp/10.parquet], [/testdata/tpch/plan_sf0.02/partsupp/11.parquet], [/testdata/tpch/plan_sf0.02/partsupp/12.parquet], [/testdata/tpch/plan_sf0.02/partsupp/13.parquet], ...]}, projection=[ps_partkey, ps_suppkey], file_type=parquet, predicate=DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
                ┌───── Stage 1 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
                │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
                │   FilterExec: s_comment@1 LIKE %Customer%Complaints%, projection=[s_suppkey@0]
                │     PartitionIsolatorExec: tasks=4 partitions=16
                │       DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/supplier/1.parquet], [/testdata/tpch/plan_sf0.02/supplier/10.parquet], [/testdata/tpch/plan_sf0.02/supplier/11.parquet], [/testdata/tpch/plan_sf0.02/supplier/12.parquet], [/testdata/tpch/plan_sf0.02/supplier/13.parquet], ...]}, projection=[s_suppkey, s_comment], file_type=parquet, predicate=s_comment@6 LIKE %Customer%Complaints%
                └──────────────────────────────────────────────────
                ┌───── Stage 2 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
                │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
    ...
    async fn test_tpch_17() -> Result<(), Box<dyn Error>> {
        ...
        │     CoalescePartitionsExec
        │       [Stage 4] => NetworkCoalesceExec: output_partitions=48, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 4 ── Tasks: t0:[p0..p11] t1:[p0..p11] t2:[p0..p11] t3:[p0..p11]
          ...
          │         LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[l_partkey@0]
          │           [Stage 3] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 2 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
            │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
            ...
            │         [Stage 1] => NetworkBroadcastExec: partitions_per_consumer=4, stage_partitions=16, input_tasks=4
            │       PartitionIsolatorExec: tasks=4 partitions=16
            │         DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/lineitem/1.parquet], [/testdata/tpch/plan_sf0.02/lineitem/10.parquet], [/testdata/tpch/plan_sf0.02/lineitem/11.parquet], [/testdata/tpch/plan_sf0.02/lineitem/12.parquet], [/testdata/tpch/plan_sf0.02/lineitem/13.parquet], ...]}, projection=[l_partkey, l_quantity, l_extendedprice], file_type=parquet, predicate=DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
              ┌───── Stage 1 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
              │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
    ...
    async fn test_tpch_18() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 6] => NetworkCoalesceExec: output_partitions=36, input_tasks=3
        └──────────────────────────────────────────────────
          ┌───── Stage 6 ── Tasks: t0:[p0..p11] t1:[p0..p11] t2:[p0..p11]
          ...
          │     LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[c_name@0, c_custkey@1, o_orderkey@2, o_orderdate@3, o_totalprice@4]
          │       [Stage 5] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 5 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
            │ RepartitionExec: partitioning=Hash([c_name@0, c_custkey@1, o_orderkey@2, o_orderdate@3, o_totalprice@4], 6), input_partitions=4
            ...
            │       CoalescePartitionsExec
            │         [Stage 2] => NetworkBroadcastExec: partitions_per_consumer=12, stage_partitions=48, input_tasks=3
            ...
            │           [Stage 4] => NetworkBroadcastExec: partitions_per_consumer=4, stage_partitions=16, input_tasks=4
            │         PartitionIsolatorExec: tasks=4 partitions=16
            │           DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/lineitem/1.parquet], [/testdata/tpch/plan_sf0.02/lineitem/10.parquet], [/testdata/tpch/plan_sf0.02/lineitem/11.parquet], [/testdata/tpch/plan_sf0.02/lineitem/12.parquet], [/testdata/tpch/plan_sf0.02/lineitem/13.parquet], ...]}, projection=[l_orderkey, l_quantity], file_type=parquet, predicate=DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
              ┌───── Stage 2 ── Tasks: t0:[p0..p47] t1:[p48..p95] t2:[p96..p143]
              │ BroadcastExec: input_partitions=12, consumer_tasks=4, output_partitions=48
              ...
              │       LocalExchangeSplitExec: input_partitions=6, base_partitions=6, local_partitions=2, exprs=[l_orderkey@0]
              │         [Stage 1] => NetworkShuffleExec: output_partitions=6, input_tasks=4
              └──────────────────────────────────────────────────
                ┌───── Stage 1 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5]
                │ RepartitionExec: partitioning=Hash([l_orderkey@0], 6), input_partitions=4
              ...
              │       [Stage 3] => NetworkBroadcastExec: partitions_per_consumer=4, stage_partitions=16, input_tasks=4
              │     PartitionIsolatorExec: tasks=4 partitions=16
              │       DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/orders/1.parquet], [/testdata/tpch/plan_sf0.02/orders/10.parquet], [/testdata/tpch/plan_sf0.02/orders/11.parquet], [/testdata/tpch/plan_sf0.02/orders/12.parquet], [/testdata/tpch/plan_sf0.02/orders/13.parquet], ...]}, projection=[o_orderkey, o_custkey, o_totalprice, o_orderdate], file_type=parquet, predicate=DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
                ┌───── Stage 3 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
                │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
                │   PartitionIsolatorExec: tasks=4 partitions=16
                │     DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/customer/1.parquet], [/testdata/tpch/plan_sf0.02/customer/10.parquet], [/testdata/tpch/plan_sf0.02/customer/11.parquet], [/testdata/tpch/plan_sf0.02/customer/12.parquet], [/testdata/tpch/plan_sf0.02/customer/13.parquet], ...]}, projection=[c_custkey, c_name], file_type=parquet
                └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_20() -> Result<(), Box<dyn Error>> {
        ...
        │         CoalescePartitionsExec
        │           [Stage 4] => NetworkBroadcastExec: partitions_per_consumer=4, stage_partitions=4, input_tasks=4
        ...
        └──────────────────────────────────────────────────
          ...
          │     [Stage 1] => NetworkBroadcastExec: partitions_per_consumer=4, stage_partitions=16, input_tasks=4
          │   PartitionIsolatorExec: tasks=4 partitions=16
          │     DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/supplier/1.parquet], [/testdata/tpch/plan_sf0.02/supplier/10.parquet], [/testdata/tpch/plan_sf0.02/supplier/11.parquet], [/testdata/tpch/plan_sf0.02/supplier/12.parquet], [/testdata/tpch/plan_sf0.02/supplier/13.parquet], ...]}, projection=[s_suppkey, s_name, s_address, s_nationkey], file_type=parquet, predicate=DynamicFilter [ empty ]
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63]
            │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
