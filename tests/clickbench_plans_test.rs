...
mod tests {
    ...
    async fn test_clickbench_4() -> Result<()> {
        ...
        └──────────────────────────────────────────────────
          ...
          │     LocalExchangeSplitExec: input_partitions=3, base_partitions=3, local_partitions=3, exprs=[alias1@0]
    ...
    async fn test_clickbench_7() -> Result<()> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       LocalExchangeSplitExec: input_partitions=3, base_partitions=3, local_partitions=3, exprs=[AdvEngineID@0]
          │         [Stage 1] => NetworkShuffleExec: output_partitions=3, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2]
    ...
    async fn test_clickbench_8() -> Result<()> {
        ...
        └──────────────────────────────────────────────────
          ...
          │ RepartitionExec: partitioning=Hash([RegionID@0], 3), input_partitions=9
          ...
          │       LocalExchangeSplitExec: input_partitions=3, base_partitions=3, local_partitions=3, exprs=[RegionID@0, alias1@1]
          │         [Stage 1] => NetworkShuffleExec: output_partitions=3, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2]
    ...
    async fn test_clickbench_10() -> Result<()> {
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 2 ── Tasks: t0:[p0..p2] t1:[p0..p2]
          │ RepartitionExec: partitioning=Hash([MobilePhoneModel@0], 3), input_partitions=9
          ...
          │       LocalExchangeSplitExec: input_partitions=3, base_partitions=3, local_partitions=3, exprs=[MobilePhoneModel@0, alias1@1]
          │         [Stage 1] => NetworkShuffleExec: output_partitions=3, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2]
    ...
    async fn test_clickbench_11() -> Result<()> {
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 2 ── Tasks: t0:[p0..p2] t1:[p0..p2]
          │ RepartitionExec: partitioning=Hash([MobilePhone@0, MobilePhoneModel@1], 3), input_partitions=9
          ...
          │       LocalExchangeSplitExec: input_partitions=3, base_partitions=3, local_partitions=3, exprs=[MobilePhone@0, MobilePhoneModel@1, alias1@2]
          │         [Stage 1] => NetworkShuffleExec: output_partitions=3, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2]
    ...
    async fn test_clickbench_13() -> Result<()> {
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 2 ── Tasks: t0:[p0..p2] t1:[p0..p2]
          │ RepartitionExec: partitioning=Hash([SearchPhrase@0], 3), input_partitions=9
          ...
          │       LocalExchangeSplitExec: input_partitions=3, base_partitions=3, local_partitions=3, exprs=[SearchPhrase@0, alias1@1]
          │         [Stage 1] => NetworkShuffleExec: output_partitions=3, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2]
